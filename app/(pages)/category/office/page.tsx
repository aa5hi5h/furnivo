...
export default function OfficePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <CategoryHero
        title="Office"
        subtitle="Productivity meets style. Create a workspace that inspires."
        backgroundImage="https://images.pexels.com/photos/3862603/pexels-photo-3862603.jpeg?auto=compress&cs=tinysrgb&w=1600"
