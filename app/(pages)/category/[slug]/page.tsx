...
import { Check, Eye, Heart, ShoppingCart, ArrowLeft } from 'lucide-react';
...
export default function DynamicCategoryPage() {
  ...
  const fetchProducts = async (categoryName: string) => {
    try {
      setLoading(true);
      const response = await fetch(`/api/products?category=${encodeURIComponent(categoryName)}&limit=100`);
            ...
            {loading ? (
              ...
              <div className="flex items-center justify-center h-96">
                <div className="text-center">
                  ...
                  <p className="text-gray-400 text-sm mb-6">Try adjusting your filters or explore other categories.</p>
                  <Link href="/">
                    <Button className="bg-[#C47456] hover:bg-[#2C2C2C]">
                      Back to Home
                    </Button>
                  </Link>
                </div>
